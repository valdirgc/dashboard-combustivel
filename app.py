...
if not df_db.empty and len(df_db) > 0 and ano_escolhido is not None:
    ...
    with aba1:
        ...
        with col1:
            ...
            st.plotly_chart(fig1, use_container_width=True, key="chart_geral_custo")
        with col2:
            ...
            st.plotly_chart(fig2, use_container_width=True, key="chart_geral_vol")
    ...
    with aba2:
        ...
        with col_s1:
            ...
            st.plotly_chart(fig_s1, use_container_width=True, key="chart_setor_custo")
        with col_s2:
            ...
            st.plotly_chart(fig_s2, use_container_width=True, key="chart_setor_vol")
    ...
    with aba3:
        ...
        with col_c1:
            ...
            st.plotly_chart(fig_c1, use_container_width=True, key="chart_comb_custo")
        with col_c2:
            ...
            st.plotly_chart(fig_c2, use_container_width=True, key="chart_comb_vol")
    ...
    with aba4:
        ...
        with col_v1:
            ...
            st.plotly_chart(fig_v1, use_container_width=True, key="chart_veic_custo")
        with col_v2:
            ...
            st.plotly_chart(fig_v2, use_container_width=True, key="chart_veic_vol")
    ...
    with aba5:
        ...
        with col_a1:
            ...
            st.plotly_chart(fig_a1, use_container_width=True, key="chart_ano_custo")
        with col_a2:
            ...
            st.plotly_chart(fig_a2, use_container_width=True, key="chart_ano_vol")
